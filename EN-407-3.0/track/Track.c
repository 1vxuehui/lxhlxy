...
{	
    ...
    speed2 = GetEncoderSpeed(TIM1->CNT);
		...
		TIM9->CCR2= motor[1].out;
		HAL_Delay(50);
if(((HAL_GPIO_ReadPin(huidu11_GPIO_Port,huidu11_Pin)) == 1 ||(HAL_GPIO_ReadPin(huidu17_GPIO_Port,huidu17_Pin)) == 1)&&(angle1>1200||angle2>1200))
{
	angle1=0;
	angle2=0;
	car_go_ahead();
...
{	
    ...
    speed2 = GetEncoderSpeed(TIM1->CNT);
		...
		TIM9->CCR2= motor[1].out;
		HAL_Delay(50);
if(((HAL_GPIO_ReadPin(huidu11_GPIO_Port,huidu11_Pin)) == 1 ||(HAL_GPIO_ReadPin(huidu17_GPIO_Port,huidu17_Pin)) == 1)&&(angle1>700||angle2>700))
{
	car_go_ahead();
   break;
}
